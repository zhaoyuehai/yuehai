...
import com.yuehai.android.common.util.DeviceUtils;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (url.contains("book/") ||
            ...
            Request request = original.newBuilder()
                    ...
                    .addHeader("X-Device-Id", DeviceUtils.getIMEI(BaseApplication.getApplication()))
                    .addHeader("Host", "api.zhuishushenqi.com")
                    .addHeader("Connection", "Keep-Alive")
                    .addHeader("If-None-Match", "W/\"2a04-4nguJ+XAaA1yAeFHyxVImg\"")
                    .addHeader("If-Modified-Since", "Fri, 04 May 2018 09:00:00 UTC")
                    .build();
